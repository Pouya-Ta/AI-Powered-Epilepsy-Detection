...
New_dir = r"C:\Users\Pouya\Documents\university\Bachelor - AUT\Final Project\Data Set\Pre\code\KNN_LOO"
output_csv = os.path.join(New_dir, "Kfold_knn_results.csv")
